...
export const comp25060503: ArticleDetail = {
  id: 25060503,
  title: '『メトロイド プライム4』本日発売――レトロスタジオ渾身の完全新章、Switch2 で4K60fps対応',
  summary:
    '6月5日、シリーズ最新作『メトロイド プライム4』が Nintendo Switch 2 向けに発売。サムスの新たな追跡任務と銀河連邦内乱を描くシネマティックFPSアドベンチャーがついにベールを脱ぐ。',
  content: `
    <p>任天堂とレトロスタジオは<strong>2025年6月5日</strong>、ファン待望のシリーズ最新作
    『<em>メトロイド プライム4</em>』（以下 MP4）を発売しました。プラットフォームは
